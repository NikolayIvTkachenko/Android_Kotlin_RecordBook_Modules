 ...
 *
 */
class AddRecordBook(private val recordBookRepository: RecordBookRepository) {

    suspend operator fun invoke(recordBook: RecordBook) = recordBookRepository.addNote(recordBook)
